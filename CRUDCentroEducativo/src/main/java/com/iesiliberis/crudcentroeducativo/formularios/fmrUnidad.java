...
public class fmrUnidad extends javax.swing.JInternalFrame {
    ...
    private void configTabla() {
        String col[] = {"Id", "Codigo", "Nombre", "Observaciones", "codCurso", "DniTutor", "codAula"};
    ...
    private void initComponents() {
        ...
        jLabel6.setText("codCurso");

        jLabel7.setText("DniTutor");

        jLabel8.setText("codAula");
        ...
        btnAtras.setIcon(new javax.swing.ImageIcon("C:\\Users\\alvar\\Desktop\\CRUDCentroEducativo\\imgJava\\cancel_FILL0_wght400_GRAD0_opsz48.png")); // NOI18N
